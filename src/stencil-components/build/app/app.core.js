...
(function(window, document, Context, namespace) {
  ...
  function attachStyles(plt, domApi, cmpMeta, hostElm) {
    ...
    // and add the scope attribute to the host
        const shouldScopeCss = 2 /* ScopedCss */ === encapsulation || 1 /* ShadowDom */ === encapsulation && !plt.domApi.$supportsShadowDom;
  ...
  const utils = {
    'getTag': vnode => vnode.vtag,
    'getChildren': vnode => vnode.vchildren,
    'getText': vnode => vnode.vtext,
